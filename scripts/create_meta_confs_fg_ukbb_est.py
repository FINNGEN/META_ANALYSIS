...
REQUIRED_COLS = ['fg_phenotype', 'fg_link', 'ukbb_link', 'estbb_link']
OPTIONAL_COLS = ['fg_n_cases', 'ukbb_n_cases', 'estbb_n_cases', 'fg_n_controls', 'ukbb_n_controls', 'estbb_n_controls']
...
def run():
    ...
    mapping[['fg_link', 'ukbb_link', 'estbb_link']].to_csv(args.sumstat_filelist_name, header=False, index=False, sep='\t')
