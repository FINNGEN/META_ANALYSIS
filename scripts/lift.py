...
def create_parser():
    ...
    parser.add_argument("file",
                        help="Whitespace separated file with either single column giving variant ID in chr:pos:ref:alt or those columns separately")
    parser.add_argument("-var",
                        help="Variant column in chr:pos:ref:alt.")
    parser.add_argument("-chr",
                        help="Chromosome column name")
    parser.add_argument("-pos",
                        help="Position column name")
    parser.add_argument("-ref",
                        help="ref column name")
    parser.add_argument("-alt",
                        help="alt column name")
    parser.add_argument("-chain_file",
                        help="optional chain file path")
    parser.add_argument("-no_clean",
                        action="store_true",
                        default=False,
                        help="Do not clean intermediate files after execution")
    parser.add_argument("-tmp_path",
                        help="Directory to use for potentially large temporary files")
    return parser
